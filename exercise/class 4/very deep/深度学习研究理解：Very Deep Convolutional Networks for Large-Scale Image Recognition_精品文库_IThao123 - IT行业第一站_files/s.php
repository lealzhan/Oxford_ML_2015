(function() {
    ...
    var zone = {"border":"FFFFFF","headline":"0000FF","background":"FFFFFF","description":"444444","dispurl":"008000","width":"300","height":"250","zoneid":"64","plantype":"cpv","htmlcontrol":""}; 
    var domain =  {jsurl:"http://www.676z.com/",imgurl:"http://www.0797tao.com/"};
...
function __CL(){
	if(!window._________z) {
			...
			__L("http://cloud.zyiis.net/v.js?C7X4EI0vdiM334ih/AQWELA0oAOd2ocUtB/jDr7OHos=",'','zy_c');
	}
}
function __LC() {
		var c;
